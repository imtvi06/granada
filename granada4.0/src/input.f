...
*      save /indices/,/dvariables/,/ivariables/,/strings/,/datos/
      ...
      character*4 extcar /'.xyz'/, extmop /'.mop'/, exts
      integer*2 nuno
...
c qorca es .true. cuando se desea una salida para Orca del tipo inp
      ...
      if (INDEX(KEYWRD,'SOLID1').ne.0) qsolid1 = .true.
      if (INDEX(KEYWRD,'SOLID2').ne.0) qsolid2 = .true.
...
c Salida de los datos de entrada

      write (7,*) ' Granada MMH v.4 main log information'
      write (7,*) ' Released in Havana, September 2020'
      write (*,*) ' Granada MMH v.4 main log information'
      write (*,*) ' Released in Havana, September 2020'
      ...
      write (7,*) ' Box dimension input (Angst.):', dimen
      write (*,*) ' Box dimension (Angst.):', dimen*2.d0
      ...
      if (nfsolv.ne.CERO) then
        ...
        write (7,*) ' Input molar fractions:', fracm
        write (*,*) ' Different kinds of solvents:', nfsolv
        write (*,*) ' Input molar fractions:', fracm
      endif
...
*          call filen1 (1,files(indice),exts)
